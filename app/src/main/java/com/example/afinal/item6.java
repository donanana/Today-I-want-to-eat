...
//        bm.setChoiceMode(ListView.CHOICE_MODE_MULTIPLE);
    ...
    private void dialog() {
        LayoutInflater inflater = LayoutInflater.from(item6.this);
        final View v = inflater.inflate(R.layout.alert, null); //final一個editText
        new AlertDialog.Builder(item6.this)
                ...
                .setPositiveButton("確定",new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        bm=new ArrayAdapter<String>(item6.this,android.R.layout.simple_list_item_checked,b_change);
                        lv2.setAdapter(bm);
                    }
                }).show();
    }
